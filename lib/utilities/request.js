...
//     }
// };
const getRequest = (url, headers = _authorizationHeaders()) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const postRequest = (url, data = {}, headers = _authorizationHeaders()) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const putRequest = (url, data = {}, headers = _authorizationHeaders()) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const res = yield (0, axios_1.default)({
            url: "http://localhost:8000 + url",
            method: "PUT",
...
//     }
// };
const deleteRequest = (url, headers = _authorizationHeaders()) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const res = yield (0, axios_1.default)({
            url: "http://localhost:8000 + url",
            method: "DELETE",
